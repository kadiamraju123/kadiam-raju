  ...
  <div class="d-flex" id="wrapper">
    ...
    <div class="border-right" id="sidebar-wrapper">
      ...
      <div class="list-group list-group-flush">
        ...
        <a href="manage_income.php" class="list-group-item list-group-item-action"><span class="bi bi-cash-stack"></span> Manage Income</a> </div>
      <div class="sidebar-heading">Settings </div>
      <div class="list-group list-group-flush">
        <a href="profile.php" class="list-group-item list-group-item-action "><span data-feather="user"></span>View Profile</a>
            ...
            <div class="card">
              <div class="card-body">
                <div class="row">
                  ...
                  <div class="col text-center">
                    <a href="manage_income.php"><img src="icon/income.png" width="57px" />
                      <p>Manage Income</p>
                    </a>
                  </div>
                  <div class="col text-center">
